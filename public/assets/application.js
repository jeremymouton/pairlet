...
function FastClick(layer) {
	...
	/** @type function() */
	this.onClick = function() { console.log(arguments); FastClick.prototype.onClick.apply(self, arguments); };

	/** @type function() */
	this.onTouchStart = function() { console.log(arguments); FastClick.prototype.onTouchStart.apply(self, arguments); };

	/** @type function() */
	this.onTouchMove = function() { console.log(arguments); FastClick.prototype.onTouchMove.apply(self, arguments); };

	/** @type function() */
	this.onTouchEnd = function() { console.log(arguments); FastClick.prototype.onTouchEnd.apply(self, arguments); };

	/** @type function() */
	this.onTouchCancel = function() { console.log(arguments); FastClick.prototype.onTouchCancel.apply(self, arguments); };
      ...
      $($field).on({
        keyup: function() {
          ...
          return timer = setTimeout(function() {
            ...
            return $('.clone').removeClass('hidden').error(function() {
              return $('.clone').addClass('hidden');
            });
          }, 600);
        }
      });
